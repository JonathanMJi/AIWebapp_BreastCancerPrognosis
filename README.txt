...
2. Take the model and dump into h5 (CNN model)  or pickle (classic model) file
3. Build Front end web application using streamlit with side menus
4. Take the inputs from web application, supply to the h5 file, which contains the model , get the output and display on the user interface
